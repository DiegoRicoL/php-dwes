...
if ($_POST) {
    $productoActual['texto'] = $_POST['texto'];
    $productoActual['busqueda'] = $_POST['busqueda'];
    $productoActual['genero'] = $_POST['genero'];
    ...
    if (isset($_COOKIE['productos'])) {
        ...
        foreach ($productos as $key => $value) {
            echo '<tr>
                    <td>' . $productos[$key]['texto'] . '</td>' .
                    '<td>' . $productos[$key]['busqueda'] . '</td>' .
                    '<td>' . $productos[$key]['genero'] . '</td></tr>';
        }
        echo '</table>';
    }
}
